...
namespace WindowsFormsApplication1 {
    ...
    ToolboxBitmap(typeof(ProgressBar), @"WindowsFormsApplication1.ProgressBar.bmp"),
    ResourceStreamAttribute("Toolbox", @"WindowsFormsApplication1.ProgressBarLarge.png, WindowsFormsApplication1")
    ]
    public class ProgressBar : XRLabel {
